...
- `tufte-bootstrap`, integrating `tufte-css` and bootstrap: https://github.com/dylan-k/tufte-bootstrap/
- `11ty + tufte.css` for markdown side and margin notes: https://11d.im/notices/md-tufte/
